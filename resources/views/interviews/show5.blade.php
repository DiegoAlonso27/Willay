<x-app-layout>
    ...
    <div class="container py-8">
        <h1 class="text-4xl fond-bold text-gray-600">Entrevista a Cordelia Sánchez García</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2">
                ...
                <b class="text-xl">Autor: Montalvan Carranza, Manuel</b></br>
                <figure>
                    <iframe class="w-full h-80 object-cover object-center my-6 rounded-md"
                        src="https://www.youtube.com/embed/HpHle3tZSdY" title="YouTube video player" frameborder="0"
