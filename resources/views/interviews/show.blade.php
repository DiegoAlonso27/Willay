<x-app-layout>
    ...
    <div class="container py-8">
        <h1 class="text-4xl fond-bold text-gray-600">Entrevista a Roxana Quispe Collantes</h1>
            ...
            <div class="lg:col-span-2">
                ...
                <figure>
                    <iframe class="w-full h-80 object-cover object-center my-6 rounded-md"
                        src="https://www.youtube.com/embed/QRYq_Cxiqws" title="YouTube video player" frameborder="0"
