<x-app-layout>
    ...
    <div class="container py-8">
        <h1 class="text-4xl fond-bold text-gray-600">Entrevista a Sadhami, voluntaria de la Enséñame</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2">
                ...
                <b class="text-xl">Autor: Matumay Ochoa, Nicol</b></br>
                <figure>
                    <iframe class="w-full h-80 object-cover object-center my-6 rounded-md"
                        src="https://www.youtube.com/embed/rr29BYAOSK8" title="YouTube video player" frameborder="0"
            ...
            <aside>
                ...
                <ul>
                    <li class="mb-4">
                        <a class="flex" href="{{ route('interviews.show4') }}">
                            <img class="w-36 h-20 object-cover object-center rounded-md"
                                src="/img/ENTREVISTA A ALVIN MEDINA.jpg" alt="">
                            <span class="w-52 ml-2 text-gray-600">Entrevista a Alvin Medina</span>
                        </a>
                    </li>
                </ul>
            </aside>
