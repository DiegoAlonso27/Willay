<div class="bg-white font-sans leading-normal tracking-normal ">
    ...
    <div class="carousel relative shadow-2xl bg-white h-32 md:h-56 lg:h-80">
        <div class="carousel-inner relative overflow-hidden w-full">
            <!--Slide 1-->
            <input class="hidden carousel-open" type="radio" id="carousel-1" name="carousel" aria-hidden="true"
                hidden="" checked="checked">
            <div class="carousel-item absolute opacity-0 h-36 md:h-56 lg:h-80">
                <img class="object-cover object-center block h-full w-full text-white text-5xl text-center"
                    src="/img/banner-min.jpg" alt="">
            </div>
