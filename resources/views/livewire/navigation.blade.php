<header class="relative bg-white z-50" x-data="{ open:false }">
        ...
        <div class="flex justify-between items-center border-b-2 border-gray-100 py-3 md:justify-start md:space-x-10">
            ...
            <div class="absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
              <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                ...
                <a href="{{ route('reports.index') }}" class="text-base font-medium text-gray-500 hover:text-red-900">
                    <i class="far fa-newspaper"></i> Noticias</a>
                <a href="#" class="text-base font-medium text-gray-500 hover:text-red-900">
                            ...
                            <div class="px-5 py-5 bg-gray-50 sm:px-8 sm:py-8">
                                <div class="mt-5 text-sm">
                                    <a href="{{ route('posts.index') }}"
                                        class="font-medium text-red-600 hover:text-red-500"> Ver todos los posts <span
        ...
        <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                ...
                <div class="mt-6">
                    <nav class="grid gap-y-8">
                        ...
                        <a href="{{ route('reports.index') }}"
                            class="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                            <span class="ml-3 text-base font-medium text-gray-900">
                                <i class="far fa-newspaper flex-shrink-0 h-6 w-6 text-red-600"></i> Noticias
                            </span>
                        </a>
            ...
            <div class="py-6 px-5 space-y-6">
                <div class="grid grid-cols-2 gap-y-4 gap-x-8">
                    @foreach ($categories as $category)
                        <a href="{{ route('posts.category', $category) }}"
                            class="text-base font-medium text-gray-900 hover:text-gray-700 hover:bg-gray-100">
                            {{ $category->name }}
                        </a>
                    @endforeach
                </div>
